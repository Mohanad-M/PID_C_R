...
#ifndef RTW_HEADER_PID_C_R_Simulink_1_0_h_
#define RTW_HEADER_PID_C_R_Simulink_1_0_h_
#include <math.h>
#include <stddef.h>
#ifndef PID_C_R_Simulink_1_0_COMMON_INCLUDES_
# define PID_C_R_Simulink_1_0_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                               /* PID_C_R_Simulink_1_0_COMMON_INCLUDES_ */

#include "PID_C_R_Simulink_1_0_types.h"
...
typedef struct {
  ...
  codertarget_arduinobase_blo_g_T obj_a;/* '<S6>/Digital Output' */
  codertarget_arduinobase_blo_g_T obj_lo;/* '<S6>/Digital Output1' */
  codertarget_arduinobase_blo_g_T obj_n;/* '<S6>/Digital Output2' */
  codertarget_arduinobase_blo_g_T obj_fk;/* '<S6>/Digital Output3' */
} DW_PID_C_R_Simulink_1_0_T;
...
} PrevZCX_PID_C_R_Simulink_1_0_T;

/* Parameters (default storage) */
struct P_PID_C_R_Simulink_1_0_T_ {
...
struct tag_RTM_PID_C_R_Simulink_1_0_T {
...
extern P_PID_C_R_Simulink_1_0_T PID_C_R_Simulink_1_0_P;

/* Block states (default storage) */
extern DW_PID_C_R_Simulink_1_0_T PID_C_R_Simulink_1_0_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_PID_C_R_Simulink_1_0_T PID_C_R_Simulink_1_0_PrevZCX;

/* External function called from main */
extern void PID_C_R_Simulink_1_0_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void PID_C_R_Simulink_1_0_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void PID_C_R_Simulink_1_0_initialize(void);
extern void PID_C_R_Simulink_1_0_step0(void);
extern void PID_C_R_Simulink_1_0_step1(void);
extern void PID_C_R_Simulink_1_0_terminate(void);

/* Real-time Model object */
extern RT_MODEL_PID_C_R_Simulink_1_0_T *const PID_C_R_Simulink_1_0_M;
 ...
 *
 * '<Root>' : 'PID_C_R_Simulink_1_0'
 * '<S1>'   : 'PID_C_R_Simulink_1_0/Environment Controller1'
 * '<S2>'   : 'PID_C_R_Simulink_1_0/Model Info'
 * '<S3>'   : 'PID_C_R_Simulink_1_0/Motors'
 * '<S4>'   : 'PID_C_R_Simulink_1_0/Open loop controller'
 * '<S5>'   : 'PID_C_R_Simulink_1_0/Motors/Left Wheels encoder'
 * '<S6>'   : 'PID_C_R_Simulink_1_0/Motors/Motor Enable'
 * '<S7>'   : 'PID_C_R_Simulink_1_0/Motors/Right Wheels encoder'
 * '<S8>'   : 'PID_C_R_Simulink_1_0/Motors/Simulated Left wheel motor'
 * '<S9>'   : 'PID_C_R_Simulink_1_0/Motors/Simulated Right wheel motor'
 * '<S10>'  : 'PID_C_R_Simulink_1_0/Motors/Left Wheels encoder/Triggered Subsystem'
 * '<S11>'  : 'PID_C_R_Simulink_1_0/Motors/Right Wheels encoder/Triggered Subsystem'
 */
#endif                                 /* RTW_HEADER_PID_C_R_Simulink_1_0_h_ */
