###########################################################################
## Makefile generated for Simulink model 'PID_C_R_Simulink_1_0_OLC'. 
## 
## Makefile     : PID_C_R_Simulink_1_0_OLC.mk
## Generated on : Sat May 08 21:24:15 2021
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PID_C_R_Simulink_1_0_OLC.elf
...
PRODUCT_NAME              = PID_C_R_Simulink_1_0_OLC
MAKEFILE                  = PID_C_R_Simulink_1_0_OLC.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PID_C_R_Simulink_1_0_OLC.elf
...
DEFINES_ = -DMODEL=PID_C_R_Simulink_1_0_OLC -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=5 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=65286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=PID_C_R_Simulink_1_0_OLC -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o PID_C_R_Simulink_1_0_OLC.o PID_C_R_Simulink_1_0_OLC_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/PID_C_R_Simulink_1_0_OLC_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/PID_C_R_Simulink_1_0_OLC_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PID_C_R_Simulink_1_0_OLC_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PID_C_R_Simulink_1_0_OLC.o : $(START_DIR)/PID_C_R_Simulink_1_0_OLC_ert_rtw/PID_C_R_Simulink_1_0_OLC.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PID_C_R_Simulink_1_0_OLC_data.o : $(START_DIR)/PID_C_R_Simulink_1_0_OLC_ert_rtw/PID_C_R_Simulink_1_0_OLC_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/PID_C_R_Simulink_1_0_OLC_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
